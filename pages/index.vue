		...
		<section class="mt-6">
			<div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 bg-gray-400">
				...
				<div class="mr-auto place-self-center lg:col-span-8">
					<h1 class="max-w-2xl mb-4 text-2xl font-extrabold leading-none lg:text-4xl">
						Habit Streak - by Jonathan Martz</h1>
					<p class="max-w-2xl mb-6 font-light text-white lg:mb-8 md:text-lg lg:text-xl">
						Meine Idee ist eine App für Habits ähnlich wie die von Kevin nur als Web App oder auch PWA.
					</p>
